...
public class CodeGenerator {
    /*private static final String JDBC_URL = "jdbc:postgresql://192.168.1.188:5432/passport";
    private static final String JDBC_USERNAME = "developer";
    private static final String JDBC_PASSWORD = "highLANDER@2017";
    private static final String JDBC_DIVER_CLASS_NAME = "org.postgresql.Driver";*/

    private static final String JDBC_URL = "jdbc:postgresql://192.168.5.200:12921/testdb2";
    ...
    public static void main(String[] args) {
        //String[] tables = {"permissions", "users"};
        //genCode(tables);
        genCodeByCustomModelName("tab_role_info","RoleInfo");
    }
    ...
    public static void genModelAndMapper(String tableName, String modelName) {
        ...
        try {
            ...
            throw new RuntimeException("Generated Model AND Mapper Failure", e);
        }

        if (generator.getGeneratedJavaFiles().isEmpty() || generator.getGeneratedXmlFiles().isEmpty()) {
            throw new RuntimeException("Generated Model AND Mapper Failure：" + warnings);
        }
    ...
    public static void genService(String tableName, String modelName) {
        try {
            ...
            System.out.println(modelNameUpperCamel + "ServiceImpl.java Generated Successfully");
        } catch (Exception e) {
            throw new RuntimeException("Generated Service Failure", e);
        }
    }
    ...
    public static void genController(String tableName, String modelName) {
        try {
            ...
            throw new RuntimeException("Generated Controller Failure", e);
        }
